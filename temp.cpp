 ...
 * 2. Assignment Name:
 *      Lab 07: Artillery Simulator
 * 3. Assignment Description:
 *      Simulate the flight path of the M777 round
 * 4. What was the hardest part? Be as specific as possible.
 *      There was some error that caused it to be consistently off and we
 *      spent all of our time trying to find it.
...
double getTotalXDistanceTraveled(double angle, double velocity)
{
   ...
   std::cout << "Angle: " << angle << " Distance: " << xpos << " Time: " << seconds << std::endl;
...
int main()
{
   ...
   return 0;
#endif
   getTotalXDistanceTraveled(0.0, 827);
   getTotalXDistanceTraveled(30.0, 827);
   getTotalXDistanceTraveled(60.0, 827);
   getTotalXDistanceTraveled(-45.0, 827);
